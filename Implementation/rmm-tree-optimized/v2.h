#ifndef RMMTREE_KARY_V2_H
#define RMMTREE_KARY_V2_H
...
class RMMTree_Kary_V2 : public RMMTree_Kary_V1{
    public: 
        RMMTree_Kary_V2(int_vector<1> &bv, int sizeBlock,  int w, int order);   //Construtor classe derivada
