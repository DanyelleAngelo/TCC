\begin{table}[h!]
	\centering
	\caption[Operações sobre a RMM-tree clássica]{Operações suportadas pela rmM-tree binária}
    ...
    preRank(i)/postRank(i) & nó $i$ usando \textit{pré-ordem \mbox{ ou } pós-ordem} \\
    preSelect(i)/postSelect(i) & índice do $i$-ésimo nó em $BV$ usando \textit{pré-ordem \mbox{ ou } pós-ordem}\\
